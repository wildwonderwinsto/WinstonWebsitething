...
import { Home, Search, LayoutGrid, ChevronDown } from 'lucide-react';
      ...
      <div className="sticky top-0 z-50 bg-zinc-950/95 backdrop-blur-sm border-b border-zinc-800">
        <div className="flex items-center justify-between p-4 md:p-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-emerald-500">
              WinstonApps
            </h1>
          </div>
          ...
          <div className="flex gap-3 max-w-4xl mx-auto">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full bg-zinc-900 border border-zinc-800 rounded-lg pl-10 pr-4 py-3 text-white placeholder:text-zinc-600 focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-transparent transition"
              />
            </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4 max-w-7xl mx-auto">
          {filteredApps.map((app) => (
            <div
              ...
              className="group relative bg-zinc-900 border border-zinc-800 rounded-xl p-4 hover:border-green-500/50 hover:bg-zinc-800 transition-all duration-200 cursor-pointer"
            >
              <div className="flex flex-col items-center gap-3">
                ...
                <div className="text-center w-full">
                  ...
                  <p className="text-xs text-zinc-500 truncate mt-1">{app.desc}</p>
                </div>
              </div>
              
              <div className="absolute inset-0 rounded-xl bg-green-500/0 group-hover:bg-green-500/10 transition-all duration-200" />
            </div>
          ))}
        </div>
